      ...
      <li style={styles.posts.post} className="_ccast_item">
        <div style={styles.posts.listObj} className="lst_obj">
          <div style={styles.posts.thumbNail}>
            <img style={styles.posts.thumbNailImg}
                 src="//b.thumbs.redditmedia.com/fUE7ZBvN3clcZKU0CKag35Rc3zNc1LQtJPculHyxjxY.jpg"/>
          </div>
          <div style={styles.posts.textBody}>
            <div style={styles.posts.postTitle}>
              ...
              <div style={styles.posts.postContentMeta}>
                ...
                <span className="h_title"><a href="http://cafe.naver.com/joonggonara/member/qkrtlaud0647/article"
                                             target="_blank">{user.nick} </a></span>
