...
(function() {
  ...
  ContentTools.ImageDialog = (function(_super) {
    ...
    ImageDialog.prototype.mount = function() {
      ...
      this._domInput.setAttribute('multiple', 'multiple');
    ...
    ImageDialog.prototype.carrousel = function(images) {
      this._images = images;
      this._domCarrousel = null;

      if (!this._domCarrousel) {
        this._domCarrousel = this.constructor.createDiv(['ct-image-dialog__carrousel']);
        this._domCarrousel.style.overflowX = 'scroll';
        this._domCarrousel.style.overflowY = 'hidden';
        this._domCarrousel.style.height = '100px';
        this._domCarrousel.style.whiteSpace = 'nowrap';

        this._domCarrouselItem = [];
        for (var i=0; i< images.length; i++) {

          this._domCarrouselItem[i] = document.createElement('IMG');
          this._domCarrouselItem[i].src = images[i]['url'];
          this._domCarrouselItem[i].style.width = '100';
          this._domCarrouselItem[i].style.height = '100';
          this._domCarrouselItem[i].style.display = 'inline';

          this._domCarrousel.appendChild(this._domCarrouselItem[i]);

          this._domCarrouselItem[i].addEventListener('click', (function (_this) {
            return function (ev) {
              return _this.trigger('imageUploader.carrousel', this.src);
            };
          })(this));
        }
      }
      this._domBody.appendChild(this._domCarrousel);
      this._domView.style.height = '220';
    ...
    ImageDialog.prototype._addDOMEventListeners = function() {
      ...
      this._domInput.addEventListener('change', (function(_this) {
        return function(ev) {
          ...
          return _this.trigger('imageUploader.fileReady', files);
        };
      })(this));
